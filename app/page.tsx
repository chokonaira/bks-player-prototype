  ...
  return (
    <>
      <header className="mb-6">
        ...
        <h1 className="font-serif text-4xl text-white">Best Kept Secret</h1>
        <p className="mt-1 text-sm text-white/50">Mobile-first player & discovery concept</p>
      </header>

      <ContinueListeningRail />

      <section className="mb-8">
        <h2 className="mb-3 font-serif text-2xl text-white">For You</h2>
      ...
      <section>
        <h2 className="mb-3 font-serif text-2xl text-white">New Releases</h2>
        <div className="flex gap-3 overflow-x-auto pb-2">
